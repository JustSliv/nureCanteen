        ...
        <v-tab-item>
          <v-card max-height="450" style="overflow-x: hidden; overflow-y: auto">
            ...
            <div style="position: absolute; top: 14%; left: 65%">
              <v-card-text>{{curLocale.tabs.tab1.context.userInfo.age}} {{info.user_info.age}}</v-card-text>
              <v-card-text>{{curLocale.tabs.tab1.context.userInfo.group}} {{ info.user_info.personGroup }}</v-card-text>
              <v-card-text>{{curLocale.tabs.tab1.context.userInfo.email}} {{info.user_info.email}}</v-card-text>
              <v-card-text>{{curLocale.tabs.tab1.context.userInfo.phone}} {{info.user_info.phone}}</v-card-text>
            </div>
            <v-divider></v-divider>
            <v-card-title>
  ...
  export default {
    ...
    data() {
      return {
            ...
            tabs: {
              ...
              tab3: {
                ...
                context: {
                  ...
                  emailRules: 'Введите правильный e-mail',
                  groupRules: 'Введите правильную group',
                  tipImage: 'Ваш аватар',
                  btnTitle: 'Изменить',
                  alert: [
                    'Данные изменены',
            ...
            tabs: {
              ...
              tab3: {
                ...
                context: {
                  ...
                  emailRules: 'Напишіть коректну e-mail',
                  groupRules: 'Напишіть коректну group',
                  tipImage: 'Ваш аватар',
                  btnTitle: 'Изменить',
                  alert: [
                    'Данні були змінені',
        ...
        emailRules: [
          v => v.match("[a-zA-Z]+@[a-zA-Z]+[.][a-zA-Z]+") || this.curLocale.tab3.context.emailRules
        ],
        groupRules: [
          v => v.match('^[a-zA-Zа-яА-Я]+-[0-9]{2}-[0-9]{1,2}$') || this.curLocale.tab3.context.groupRules
        ]
      }
    },
    beforeMount() {
