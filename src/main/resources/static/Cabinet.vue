            ...
            >
                ...
                <v-tab-item>
                    <v-card max-height="450" style="overflow-x: hidden; overflow-y: auto">
                        ...
                        <v-card-text style="position: absolute; top: 75%; left: 85%">
                          {{info.last_buy.date}}
                        </v-card-text>
                        <v-divider></v-divider>
                        <v-list>
                ...
                <v-tab-item>
                    <v-card flat max-height="450" style="overflow-x: hidden; overflow-y: auto">
                        ...
                        <div v-else style="margin: 30% 0 30% 35%">
                            <v-icon style="margin-left: 20%">warning</v-icon>
                            <v-card-title>Заказов не найдено</v-card-title>
                        </div>
                    </v-card>
                </v-tab-item>
                <v-tab-item>
                            ...
                            <v-container style="margin-left: 18%">
                                <v-row>
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field
                                                v-model="fname"
                                                :label="info.user_info.fName"
                                                :content="info.user_info.fName"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                    <v-col
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field
                                                v-model="sName"
                                                :label="info.user_info.sName"
                                                :content="info.user_info.sName"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field type="number"
                                                v-model="age"
                                                :label="info.user_info.age"
                                                :content="info.user_info.age"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                    <v-col
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field
                                                v-model="group"
                                                :content="info.user_info.personGroup"
                                                :label="info.user_info.personGroup"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field type="email"
                                                v-model="email"
                                                :label="info.user_info.email"
                                                :content="info.user_info.email"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                    <v-col
                                    ...
                                    >
                                        ...
                                        <v-row>
                                            <v-text-field
                                                v-model="phone"
                                                :label="info.user_info.phone"
                                                :content="info.user_info.phone"
                                            ></v-text-field>
                                        </v-row>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col
                                        ...
                                        sm="2"
                                    >
                                        <v-img width="50" height="50" :src="avatar" v-model="avatar"></v-img>
                                    </v-col>
                                    <v-col
                                        cols="10"
                                        md="4"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                dt: axios.get('/person').then(resp => console.log(resp)),
                tabs: false,
                editDialog: false,
                info: {
                    user_info: {
